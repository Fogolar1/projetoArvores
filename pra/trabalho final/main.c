...
void casoMedio(int numExec){
    ...
    printf("\nREsultado antes = %i", execsArvoreB1);
    ...
    printf("\nResultado = %i", execsArvoreB1);

    salvar(saidaMedio, numExec);
}

void piorCaso(int numExec){
    ArvoreAVL* arvoreAVL = criar();
    ArvoreB* arvoreB1 = criaArvore(1);
    ArvoreB* arvoreB5 = criaArvore(5);
    ArvoreB* arvoreB10 = criaArvore(10);
...
void main(){
    ...
    for(int numExec = 0; numExec <= 0; numExec++){
